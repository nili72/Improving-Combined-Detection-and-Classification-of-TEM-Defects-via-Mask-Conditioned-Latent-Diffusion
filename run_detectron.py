...
from analyze_maskrcnn import analyze_checkpoints, plot_learning_curve, plot_overall_stats_vs_iou_threshold, save_excel_together_finalreport
...
if __name__=='__main__':
    ...
    if input_yaml['analyze_maskrcnn'] == True:
        ...
        analyze_maskrcnn(cfg, defect_metadata, input_yaml, analyze_test=True, analyze_train=True)
        print("all completed!")
