...
def match_true_and_predicted_defects_iou_bbox(true_classes_all_oneimage_sorted, pred_classes_all_oneimage_sorted,
    ...
    # print("debug match_iou_box- ","true_defectsizes_bdot_nm_foundonly, true_defectsizes_111_nm_foundonly, true_defectsizes_100_nm_foundonly, \
    #         \n pred_defectsizes_bdot_nm_foundonly,  pred_defectsizes_111_nm_foundonly, pred_defectsizes_100_nm_foundonly, \
    #         \n true_defectshapes_bdot_foundonly, true_defectshapes_111_foundonly, true_defectshapes_100_foundonly, \
    #         \n pred_defectshapes_bdot_foundonly, pred_defectshapes_111_foundonly, pred_defectshapes_100_foundonly",\
    ...
    for model_checkpoint in model_checkpoints:
        ...
        if checkpoints_done < num_checkpoints:
            for true_and_pred_matching_threshold in true_and_pred_matching_thresholds:
                ...
                # Make parity plots for sizes/densities/shapes
                # (In the interest of brevity, you can encapsulate all these repeated scatter-plot
                # blocks into your own helper functions, e.g. `plot_size_parity()`, etc.
                # For demonstration, we keep them inline here—but removed extra duplication.)

                # For example, a single call to a custom function could handle each <hkl> category:
                #   plot_size_parity(...) or plot_shape_parity(...)

                # ... [Parity-plot code omitted for brevity, but it's the same logic as your original]
                ##########
                #
                ...
                # image_name_list_bd_size = copy(data['image_name_list'])
                ...
                # fig.savefig(os.path.join(sum_path, 'DefectSize_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                ...
                # pd.DataFrame().from_dict(data=data_dict).to_excel(os.path.join(sum_path,'DefectSize_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                ...
                # image_name_list_111_size = copy(data['image_name_list'])
                ...
                # image_name_list_100_size = copy(data['image_name_list'])
                ...
                # d = {'R2': r2, 'MAE': mae, 'root_mean_squared_error': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(sum_path, 'DefectSize_ParityPlot_TruePredMatch_' + str(
                ...
                # d = {'R2': r2, 'MAE': mae, 'RMSE': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(sum_path, 'DefectSize_AvgStdev_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                ...
                # image_name_list_bd_density = copy(data['image_name_list'])
                ...
                # d = {'R2': r2, 'MAE': mae, 'RMSE': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(sum_path, 'DefectDensity_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                #                  '_IoUScoreThresh_' + str(iou_score_threshold_test) + '_Blackdot' + '.png'), dpi=250, bbox_inches='tight')
                # data_dict = dict()
                ...
                # pd.DataFrame().from_dict(data=data_dict).to_excel(os.path.join(sum_path,'DefectDensity_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                #                  '_IoUScoreThresh_' + str(iou_score_threshold_test) + '_Blackdot' + '.xlsx'))
                ...
                # image_name_list_111_density = copy(data['image_name_list'])
                ...
                # image_name_list_100_density = copy(data['image_name_list'])
                ...
                # d = {'R2': r2, 'MAE': mae, 'RMSE': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(cfg.sum_path, 'DefectDensity_AvgStdev_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                #                  '_IoUScoreThresh_' + str(iou_score_threshold_test) + '_AllDefects' + '.png'), dpi=250, bbox_inches='tight')
                ...
                # image_name_list_bd_shape = copy(data['image_name_list'])
                ...
                # d = {'R2': r2, 'MAE': mae, 'RMSE': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(sum_path, 'DefectShape_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                #                  '_IoUScoreThresh_' + str(iou_score_threshold_test) + '_Blackdot' + '.png'), dpi=250, bbox_inches='tight')
                # data_dict = dict()
                ...
                # pd.DataFrame().from_dict(data=data_dict).to_excel(os.path.join(sum_path,'DefectShape_ParityPlot_TruePredMatch_' + str(true_and_pred_matching_threshold) +
                #                  '_IoUScoreThresh_' + str(iou_score_threshold_test) + '_Blackdot' + '.xlsx'))
                ...
                # image_name_list_111_shape = copy(data['image_name_list'])
                ...
                # image_name_list_100_shape = copy(data['image_name_list'])
                ...
                # d = {'R2': r2, 'MAE': mae, 'RMSE': rmse}
                # plot_stats(fig, d, x_align=0.15, y_align=0.90, type='float')
                # fig.savefig(os.path.join(sum_path, 'DefectShape_AvgStdev_ParityPlot_TruePredMatch_' + str(
                #     true_and_pred_matching_threshold) +'_IoUScoreThresh_' + str(iou_score_threshold_test) + '_AllDefects' + '.png'),
                #             dpi=250, bbox_inches='tight')
                # # Save data_dict_per_image to JSON
                # with open(os.path.join(sum_path,
